...
public class LogTableGenerator {
    ...
    public void logTableUtils(List keyList, List<List<String>> dataList, boolean isResult) {
        if (dataList.size() > 0) {
            System.out.println(generateTable(keyList, dataList));
            AtuReports.failResults("Compare ", "--", "true", String.valueOf(isResult));
        }
    }
}