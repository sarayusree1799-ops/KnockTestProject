...
public class JsonSchemaValidationUtil {
    ...
    public static ProcessingReport getResult(File schemaFile, String jsonText) throws ProcessingException, IOException {
        final JsonSchema schemaNode = getSchemaNode(schemaFile);
        final JsonNode jsonNode = getJsonNode(jsonText);
    ...
    public static ProcessingReport getResult(String schemaText, String jsonText)
